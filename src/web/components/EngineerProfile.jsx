...
class EngineerProfile extends Component {
    ...
    componentDidMount(){
        this.engineerProfile(process.env.REACT_APP_BASE_URL+`/api/v1/engineer/`+this.props.match.params.id)
    }
        ...
        return (
            ...
            <Container className='justify-content-center mt-3' style={{ paddingBottom:'20px'}}>
                ...
                <Col md='3'>
                    ...
                    <Card style={{ marginBottom:'15px', marginRight: '20px', borderRadius:'12%', width: '14rem', height:'20rem', backgroundImage: `url(/img/profile.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <Card.Body style={{ height: '200px'}}>
                    </Card.Body>
                    </Card> : 
                    <Card style={{ marginBottom:'15px', marginRight: '20px', borderRadius:'12%', width: '14rem', height:'20rem', backgroundImage: `url(`+process.env.REACT_APP_BASE_URL+`/engineer/${this.props.Engineers.photo})`, backgroundPosition: 'center', backgroundSize: 'cover' }}>
                    <Card.Body style={{ height: '200px'}}>
                    </Card.Body>
                    </Card> }
                    </Col>
                ...
                <tbody>
                    ...
                    <td><NumberFormat value={this.props.Engineers.expectsalary} displayType='text' thousandSeparator prefix='Rp. ' /></td>
                    </tr>
                    <tr>
                    <td>Skill</td>
